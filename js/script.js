...
var optionsLP = {
    title: { display: true, text: 'Privacion de sueño', fontSize: '24', fontFamily: "'Roboto', sans-serif"},
...
var optionsEC = {
    title: { display: true, text: 'Actividades Nocturnas', fontSize: '24', fontFamily: "'Roboto', sans-serif"},
...
var optionsEPM = {
    title: { display: true, text: 'Mi progreso', fontSize: '24', fontFamily: "'Roboto', sans-serif"},
    legend: { display: false},
    scale: {
...
costGroupedByCategoryBenchmark.unshift(
    {
        type: 'line',
        label: 'Benchmark',
...
var optionsECB = {
    title: { display: true, text:'Tu camino', fontSize: '24', fontFamily: "'Roboto', sans-serif"},
    legend: {display: true, position: 'right', align: 'center'},
    scales: {
        xAxes: [{
          ticks: {
        ...
        scaleLabel: { display: true, labelString: 'Tus actividades por categoria'}
        }],
        yAxes: [{
          ticks: {
              beginAtZero: true, userCallback: function(value) {
